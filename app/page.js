        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-10">
            {bundles.map((bundle, i) => (
              <div
                key={bundle.id}
                className="group relative bg-slate-50 border border-slate-200 rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-md hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 flex flex-col"
              >
                {bundle.popular && (
